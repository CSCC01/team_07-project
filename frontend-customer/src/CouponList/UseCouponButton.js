        ...
        trigger={
          <div>
            <Button
              variant="outlined"
              color="default"
              disabled={props.coupon.status !== 'available'}
        ...
        {(close) => (
          ...
          <div style={{ margin: 20, marginTop: 50, textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '1.2em', marginTop: 10 }}>
              Are you sure you want to <span className="request-highlight">redeem</span> this coupon?
            </p>
            <Button
              variant="outlined"
              color="#000"
              onClick={()=>{close();sendCouponRequest();}}
