...
#### 3.2. Coding work
During the meeting, task assignments will be discussed by all team members. Hopefully, everyone takes on tasks and completes them out of his/her own choice. If that is not the case, we will try to divide tasks as fair as possible, a coin toss can be used when necessary.
...
##### 4.2.3. Branching
Team members are expected to commit their code on feature branches. Branch name should follow the mainstream convention: use lower case letters, numbers and use minus sign as separator (e.g. `contact-page`).
...
If a team member needs to miss a meeting due to the irresistible factors, he/she must provide a valid reason for missing the meetings and notify team members one day ahead of the meeting time. Missing meetings consistently will be reported in peer evaluation.
