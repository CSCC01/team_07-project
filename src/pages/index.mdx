...
<img style="max-height: 100px;" src="https://raw.githubusercontent.com/yifeiyin/C01-Write-Ups/master/src/images/icon.png"></img>
...
<img src="https://raw.githubusercontent.com/yifeiyin/C01-Write-Ups/master/src/images/group-photo.jpg"></img>

As a team, our goal is to develop a piece of software that will be selected by the client and merged into their project. We also want to thoroughly understand course material and get gpa of 4.0, while having fun developing software.

- We all have experience with Agile Software Development and are familiar with scrum master and meetings.
- We are all co-op students, and two of us already had work team experience, which means we have excellent interpersonal skills and communication abilities.
- We are experienced in object-oriented programming. We are familiar with Java, Python, JavaScript, C.
...
Yiyang is a third-year Computer Science student in the Software Engineering stream. He is currently interested in web developing, and he wants to be a full stack developer. Thus, he taught himself various front end tools like HTML, CSS and JavaScript, and he also has experience in React Native and React. The programming languages he uses include Python, Java, C and JavaScript. He is a self-motivated person who constantly learn new skills and try those skills out in his github projects. He is fine with group working as he has once served as a scrum master in the course Software Design (CSCB07) for a group of six people. He is a game lover, a big fan of Don’t Starve, Terraria and Minecraft. He started learning guitar in recent months.
...
<img class="member-photo" src="https://raw.githubusercontent.com/yifeiyin/C01-Write-Ups/master/src/images/photo-katrina.jpeg"></img>
...
### Digital Signatures
By signing my name digitally here, I acknowledge that I have read, understand, and agree to the team agreement stated above.
- Yifei Yin
- Ruixin Zhuang
- Xinyi Chen
- Min Qi Zhang
